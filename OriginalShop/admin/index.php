...
<div class="container mx-auto mt-5 text-end">
	<a href="../views/login.php" class="text-dark"><i class="fa-solid fa-angle-right fa-2x"></i></a>
</div>
    ...
    <div class="container mt-3">
        <div class="card w-50 mx-auto border-0">
            ...
            <div class="card-body text-center">
                <form action="../actions/admin-login.php" method="post" class="form-group">
                ...
                <button type="submit" class="btn btn-outline-danger col-8 mt-5 text-center">Login</button>
                </form>
            </div>
        </div>
    </div>
